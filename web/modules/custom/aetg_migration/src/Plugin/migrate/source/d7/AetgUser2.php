...
namespace Drupal\aetg_migration\Plugin\migrate\source\d7;
 ...
 * )
 */
class AetgUser2 extends FieldableEntity {
  ...
  public function prepareRow(Row $row) {
    ...
    // Get Field API field values.
    foreach (array_keys($this->getFields('profile2', $this->configuration['bundle'])) as $field) {
      $uid = $row->getSourceProperty('pid');
      $row->setSourceProperty($field, $this->getFieldValues('profile2', $field, $uid));
    }
